  ...
  config = mkIf cfg.enable {
    ...
    fileSystems = {
      ...
      "/run/media/klee/DATA-HDD" = {
        ...
        fsType = "ntfs3";
        options = [ "nofail" "x-systemd.device-timeout=5s" "uid=1000" "gid=100" "rw" "user" "windows_names" ];
      };
      ...
      "/run/media/klee/DATA-M.2" = {
        ...
        fsType = "ntfs-3g";
        options = [ "nofail" "x-systemd.device-timeout=5s" "uid=1000" "gid=100" "rw" "user" "force" ];
      };
